...
###
# From https://github.com/fluxcd/flux/blob/v1.20.2/docker/known_hosts.sh
# License: Apache 2.0 https://github.com/fluxcd/flux/blob/v1.20.2/LICENSE
# Solves this issue: https://github.com/fluxcd/flux/issues/724
###
